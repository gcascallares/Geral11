...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="https://gcascallares.github.io/Geral11/mini.jpg" />
  ...
  <body>
    ...
    <section class="about_section layout_padding" id="">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="detail-box">
              <div class="heading_container">
                <h2>Vestimenta & Actividad</h2>
              </div>
              <h3>Vení cómodo y con ganas de divertirte.
Te recomendamos ropa deportiva o casual.
Si te animás, ¡traé zapatillas y sumate al partido!</h3>
            </div>
          </div>
          <div class="col-md-2">
            <div class="img-box">
              <img src="images/meta.gif" alt="" />
            </div>
          </div>
        </div>
      </div>
